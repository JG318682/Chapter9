/**
 * Board: A n x m game board made of of individual ab tiles.
 * 
 * For the game of concentration",the board is made up of
...
// int [][][] vendingMachine = new Integer[7][6][8]
// int [][] concentrationBoard = new Integer[3][4]